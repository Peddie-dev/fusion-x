    ...
    <section className="relative isolate overflow-hidden pt-16 text-center md:pt-[160px]">
      ...
      <div className="relative z-10">
        ...
        <div className="mx-auto max-w-[760px] px-5 md:px-10">
          <h2 className="text-[28px] font-bold leading-[1.1] tracking-[-1.92px] text-[#F8FAFC] md:text-[64px]">
            Designing products that move businesses{" "}
            <span className="text-[#8777F3]">forward</span>.
          </h2>
          <p className="mx-auto mt-8 max-w-[760px] text-[15px] leading-[1.7] tracking-[-0.22px] text-[#B8B8C7] md:text-[22px]">
